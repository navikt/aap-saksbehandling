...
export const hentSakPersoninfo = async (saksnummer: string) => {
...
export const hentAlleDokumenterPåSak = async (saksnummer: string) => {
  ...
  return await fetchProxy<DokumentInfo[]>(url, saksbehandlingApiScope, 'GET');
};
...
export const hentMedlemskapGrunnlag = async (behandlingsReferanse: string) => {
...
export const hentResultat = async (referanse: string) => {
...
export const purrPåLegeerklæring = async (dialogmeldingUUID: string) => {
