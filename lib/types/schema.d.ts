...
export interface components {
  schemas: {
    ...
    'no.nav.aap.behandlingsflyt.behandling.avklaringsbehov.flate.Historikk': {
      ...
      /**
       * Format: date-time
       * @example 2025-06-02T16:15:59.885627
       */
      tidspunkt: string;
    };
    ...
    'no.nav.aap.behandlingsflyt.faktagrunnlag.klage.klagebehandling.kontor.flate.KlagevurderingKontorDto': {
      ...
      /**
       * Format: date-time
       * @example 2025-06-02T14:15:59.885756Z
       */
      opprettet: string;
      'vilk\u00E5rSomOmgj\u00F8res': (
        | 'FOLKETRYGDLOVEN_11_2'
    ...
    'no.nav.aap.behandlingsflyt.faktagrunnlag.saksbehandler.institusjon.flate.RefusjonsKravDto': {
      navKontor: string;
      /**
       * Format: date
       * @example 2025-06-02
