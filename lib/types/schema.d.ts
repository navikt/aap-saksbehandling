...
export interface components {
  schemas: {
    ...
    'no.nav.aap.behandlingsflyt.behandling.avklaringsbehov.flate.Historikk': {
      ...
      /**
       * Format: date-time
       * @example 2024-09-12T11:40:49.30776
       */
      tidspunkt: string;
    };
    ...
    'no.nav.aap.behandlingsflyt.faktagrunnlag.bruddaktivitetsplikt.BruddAktivitetspliktHendelse': {
      /** @enum {string} */
      brudd:
        | 'IKKE_MØTT_TIL_MØTE'
    ...
    'no.nav.aap.behandlingsflyt.faktagrunnlag.bruddaktivitetsplikt.BruddAktivitetspliktResponse': {
      hendelser: components['schemas']['no.nav.aap.behandlingsflyt.faktagrunnlag.bruddaktivitetsplikt.BruddAktivitetspliktHendelse'][];
    };
