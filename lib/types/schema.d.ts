...
export interface paths {
  ...
  '/test/yrkesskadeMock': {
    post: {
      requestBody?: {
        content: {
          'application/json': components['schemas']['no.nav.aap.behandlingsflyt.OpprettYrkesskadeTestCase'];
        };
      };
      responses: {
        /** @description OK */
...
export interface components {
  schemas: {
    ...
    'no.nav.aap.behandlingsflyt.OpprettYrkesskadeTestCase': {
      ident: string;
      /**
       * Format: date
       * @example 2024-06-20
    ...
    'no.nav.aap.behandlingsflyt.avklaringsbehov.flate.Historikk': {
      ...
      /**
       * Format: date-time
       * @example 2024-06-20T13:43:02.152866
       */
      tidspunkt: string;
    };
    ...
    'no.nav.aap.behandlingsflyt.flyt.flate.JobbDto': {
      /** Format: int32 */
    ...
    'no.nav.aap.behandlingsflyt.flyt.flate.Prosessering': {
      ...
      ventendeOppgaver: components['schemas']['no.nav.aap.behandlingsflyt.flyt.flate.JobbDto'][];
    };
