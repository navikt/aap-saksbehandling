...
import { Behandlingsstatus } from "../behandlingsstatus/Behandlingsstatus";
import { OppgaveStatus, OppgaveStatusType } from "../oppgavestatus/OppgaveStatus";
          ...
          <VStack gap="2">
              {!behandlingsStatus?.length ? (
                  ...
                  behandlingsStatus.map((søk, index) => (
                      <Behandlingsstatus key={index} status={søk.status} />
                  ))
              )}
          </VStack>
      </div>
