...
describe('tabell for å vise inntekter', () => {
  ...
  it('har en tekst som informerer om når innbygger fikk nedsatt arbeidsevne', () => {
    ...
    expect(screen.getByText(`Innbygger fikk arbeidsevnen nedsatt i ${yrkesevneNedsattÅr}`));
  });
