...
} from 'components/behandlinger/aktivitetsplikt/avbryt/vurdering/AvbrytAktivitetspliktbehandling';
...
export const OppgaveKolonne = async ({ behandlingsreferanse, aktivGruppe, className }: Props) => (
  <section className={className}>
    ...
    {aktivGruppe === 'AVBRYT_AKTIVITETSPLIKTBEHANDLING' && <AvbrytAktivitetspliktbehandling behandlingsreferanse={behandlingsreferanse} />}
  </section>
);
