...
/**
 * Skriv test for disse scenarioene
 *
 *
 * Lagt til et nytt alternativ for ikke møtt til annen aktivitet.
 * Nytt felt for grunn til brudd.
 * Valgene i feltet for grunn til brudd.
 * Feltet for grunn skal bare vises dersom det er paragraf 11-8 (enten valgt eller så er det default på ikke møtt til annen aktivitet)
 * Tester for dynamisk label på grunn
 *
 * Nytt form i aktivitetshendelsestabell.
 * Skriv tester for alt der.
 */
  ...
  describe('Felt for å registrere brudd', () => {
    ...
    it('skal ha alle valgene i feltet for å registrere brudd på aktivitetsplikten', () => {
      ...
      const ikkeMøttTilAnnenAktivitet = screen.getByRole('radio', {
        name: /ikke møtt til annen aktivitet/i,
      });
