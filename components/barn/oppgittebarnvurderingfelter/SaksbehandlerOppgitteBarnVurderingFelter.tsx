...
export const SaksbehandlerOppgitteBarnVurderingFelter = ({
  readOnly,
  barneTilleggIndex,
  vurderingIndex,
  form,
    ...
    <div className={'flex-column'}>
      ...
      {harOppgittFosterforelderRelasjon && (
        <RadioGroupWrapper
          ...
          control={form.control}
          name={`saksbehandlerOppgitteBarnVurderinger.${barneTilleggIndex}.vurderinger.${vurderingIndex}.erFosterforelder`}
          readOnly={readOnly}
          rules={{
      ...
      {erFosterforelder !== JaEllerNei.Nei && (
        <RadioGroupWrapper
          ...
          control={form.control}
          name={`saksbehandlerOppgitteBarnVurderinger.${barneTilleggIndex}.vurderinger.${vurderingIndex}.harForeldreAnsvar`}
          readOnly={readOnly}
      ...
      {skalSetteEnFraOgMedDato && (
        <DateInputWrapper
          ...
          readOnly={readOnly}
          control={form.control}
          name={`saksbehandlerOppgitteBarnVurderinger.${barneTilleggIndex}.vurderinger.${vurderingIndex}.fraDato`}
          rules={{
            validate: {
