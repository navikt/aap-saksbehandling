...
describe('Oppsummering', () => {
  it('skal ha korrekt overskrift dersom det er sendt tilbake fra beslutter', () => {
    render(<Oppsummering vurderinger={[vurderingIkkeGodkjent]} erKvalitetssikrer={false} />);
  ...
  it('skal ha korrekt overskrift dersom det er sendt tilbake fra kvalitetssikrer', () => {
    render(<Oppsummering vurderinger={[vurderingIkkeGodkjent]} erKvalitetssikrer={true} />);
  ...
  it('skal vise korrekt verdi på om vilkåret er vurdert godkjent', () => {
    render(<Oppsummering vurderinger={[vurderingGodkjent]} erKvalitetssikrer={false} />);
