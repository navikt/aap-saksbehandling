import { StansOpphør, StansOpphørÅrsak } from 'lib/types/types';
import { TableStyled } from 'components/tablestyled/TableStyled';
import { BodyShort, Box, List, Table } from '@navikt/ds-react';
import { formaterDatoForFrontend } from 'lib/utils/date';
import { storForbokstav } from 'lib/utils/string';

export const StansOpphørTabell = ({ stansOpphør }: { stansOpphør: StansOpphør[] }) => (
  <TableStyled>
    <Table.Header>
      <Table.Row>
    ...
    <Table.Body>
      {stansOpphør.map(({ stansOpphørFraOgMed, historikk }) => {
