...
function mapGrunnlagTilUnntaksvilkår(harForutgåendeMedlemskap?: boolean | null, varMedlemMedNedsattArbeidsevne?: boolean | null, medlemMedUnntakAvMaksFemÅr?: boolean | null) {
...
export const ManuellVurderingForutgåendeMedlemskap = ({ grunnlag, readOnly, behandlingVersjon }: Props) => {
  ...
  const { form, formFields } = useConfigForm<FormFields>(
    {
      ...
      unntaksvilkår: {
        ...
        options: [
          {value: 'A', label: 'a: Ja, brukeren har vært medlem i forlketrygden i minst ett år umiddelbart før krav om ytelsen settes frem {{søknadsdato}}, og var medlem i trygden da arbeidsevnen ble nedsatt med minst halvparten {{beregningstidspunkt}}, og etter fylte 16 år har perioder med medlemskap som minst tilsvarer perioder uten medlemskap'},
          {value: 'B', label: 'b: Ja, brukeren har vært medlem i folketrygden i minst ett år umiddelbart før krav om ytelsen settes fram {{søknadsdato}}, og har etter fylte 16 år vært medlem i folketrygden med unntak av maksimum fem år.'},
          {value: 'Nei', label: 'Nei'},
        ],
  ...
  return (
    <VilkårsKort heading={'§ 11-2 Forutgående medlemskap'} steg={'VURDER_MEDLEMSKAP'}>
