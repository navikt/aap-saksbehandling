...
} from "components/behandlinger/forutgåendemedlemskap/manuellvurderingforutgåendemedlemskap/ManuellVurderingForutgåendeMedlemskap";

const user = userEvent.setup();
const grunnlag: ForutgåendeMedlemskapGrunnlag = {};
describe('Lovvalg og medlemskap ved søknadstidspunkt', () => {
  it('Skal ha en overskrift', () => {
    render(<ManuellVurderingForutgåendeMedlemskap readOnly={false} behandlingVersjon={0} grunnlag={grunnlag}/>);
