...
describe('Avbryt aktivitetspliktbehandling', () => {
  it('har en overskrift', () => {
    render(<AvbrytAktivitetspliktbehandlingVurdering grunnlag={grunnlag} readOnly={false} behandlingVersjon={1} />);
  ...
  it('viser en feilmelding dersom man forsøker å bekrefte uten å ha skrevet en begrunnelse', async () => {
    render(
      <AvbrytAktivitetspliktbehandlingVurdering
        grunnlag={{
          vurdering: { begrunnelse: '', vurderingerMeta: {}, årsak: 'BEHANDLINGEN_BLE_OPPRETTET_VED_EN_FEIL' },
        }}
        readOnly={false}
        behandlingVersjon={1}
      />
