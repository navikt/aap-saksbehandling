...
import { OvergangArbeidVurdering } from 'lib/types/types';
...
interface VurderingProps {
  vurdering: OvergangArbeidVurdering;
...
interface Props {
  historiskeVurderinger: OvergangArbeidVurdering[];
  gjeldendeVurderinger: OvergangArbeidVurdering[];
  søknadstidspunkt: string;
}
...
export const TidligereVurderinger = ({ historiskeVurderinger, gjeldendeVurderinger, søknadstidspunkt }: Props) => {
  ...
  const erVurderingenGjeldende = (historiskVurdering: OvergangArbeidVurdering) => {
