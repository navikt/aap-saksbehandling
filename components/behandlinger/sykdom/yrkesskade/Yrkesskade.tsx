...
export interface YrkesskadeFormFields {
  begrunnelse: string;
  erÅrsakssammenheng: string;
  relevanteSaker?: string[];
  relevanteYrkesskadeSaker?: YrkesskadeSak[];
  andelAvNedsettelsen?: number;
}
export interface YrkesskadeSak {
  ref: string;
...
type DraftFormFields = Partial<YrkesskadeFormFields>;
