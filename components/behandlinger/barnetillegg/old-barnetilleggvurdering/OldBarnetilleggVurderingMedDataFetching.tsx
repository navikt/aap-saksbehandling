...
import { OldBarnetilleggVurdering } from 'components/behandlinger/barnetillegg/old-barnetilleggvurdering/OldBarnetilleggVurdering';
...
export const OldBarnetilleggVurderingMedDataFetching = async ({ behandlingsreferanse, stegData }: Props) => {
