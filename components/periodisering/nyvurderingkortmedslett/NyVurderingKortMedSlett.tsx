...
interface Props {
  ...
  visStrekVedManglendeTilDato?: boolean;
}

export const NyVurderingKortMedSlett = ({
  fraDato,
  nestePeriodeFraDato,
  isLast,
  vurderingStatus,
  ...
  accordionsSignal,
  visStrekVedManglendeTilDato = true,
}: Props) => {
        ...
        <HStack justify={'space-between'} padding={'space-8'}>
          <BodyShort size={'small'}>
            ...
            {nestePeriodeFraDato ? (
              ...
              !isLast && visStrekVedManglendeTilDato && <span> – [Ikke valgt]</span>
            )}
          </BodyShort>
