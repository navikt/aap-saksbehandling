import { clientHentDialogmeldingerForSak } from 'lib/services/dokumentinnhentingservice/dokumentinnhentingservice';
...
export async function GET(_: NextApiRequest, props: { params: Promise<{ saksnummer: string }> }) {
  ...
  const data = await clientHentDialogmeldingerForSak(params.saksnummer);
